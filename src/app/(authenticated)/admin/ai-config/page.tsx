...
export default function AIConfigPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">AI 評分模型配置</h1>
        <p className="text-gray-500 mt-1">調整系統評分的核心權重。更改後將影響所有使用者的面試結果。（僅管理員可修改）</p>
      </div>
      <Card title="評分權重分配" action={<Button size="sm" variant="outline" onClick={addWeight}><Plus size={14} className="mr-1" />新增指標</Button>}>
        <div className="flex items-center gap-2 mb-4 text-gray-500"><Scale size={18} /><span className="text-sm font-medium">配置各評分維度的權重比例</span></div>
